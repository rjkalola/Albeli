package com.ecommerce.imagepickers.utils
...
import com.ecommerce.imagepickers.transformation.BlurTransformation
import com.ecommerce.imagepickers.transformation.ColorFilterTransformation
import com.ecommerce.imagepickers.transformation.GrayscaleTransformation
import com.ecommerce.imagepickers.transformation.RoundedCornersTransformation
...
import com.ecommerce.imagepickers.GlideApp
...
object GlideUtil {
     ...
     */
    fun getImageBitmap(
        url: String?, context: Context?, imageLoadingListener: ImageLoadingListener?
    ) {
        GlideApp
            .with(context!!)
            .asBitmap()
